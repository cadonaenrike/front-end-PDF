    ...
    <div className="p-8">
      ...
      <div className="border-2 rounded-xl py-5">
        <div className="bg-white rounded-xl p-6">
          <h3 className="text-xl font-bold mb-4 flex items-center">
            <span className="mr-2">
              ...
              >
                ...
                <path d="M2.5 13.75H5.01125V16.25H2.5V13.75Z" fill="#004AAD" />
                <path d="M7.5 13.75H27.5V16.25H7.5V13.75Z" fill="#004AAD" />
                <path d="M2.5 21.25H5.01125V23.75H2.5V21.25Z" fill="#004AAD" />
          ...
          <p>
            <strong>Data de nascimento:</strong> {accountData.dataNascimento}
          </p>
          <p>
            <strong>Email:</strong> {accountData.email}
          </p>
          <p>
            <strong>Telefone celular:</strong> {accountData.telefoneCelular}
          </p>
          <div className="mt-4">
